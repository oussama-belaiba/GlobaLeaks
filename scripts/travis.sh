...
if [ "$GLTEST" = "test" ]; then
  ...
  declare -a capabilities=(
    ...
    "export SELENIUM_BROWSER_CAPABILITIES='{\"browserName\":\"Firefox\", \"version\":\"34\", \"platform\":\"Windows 10\", \"seleniumVersion\":\"3.5.3\", \"maxDuration\":\"7200\", \"commandTimeout\":\"600\", \"idleTimeout\":\"270\"}'"
    "export SELENIUM_BROWSER_CAPABILITIES='{\"browserName\":\"Firefox\", \"version\":\"55\", \"platform\":\"Windows 10\", \"seleniumVersion\":\"3.5.3\", \"maxDuration\":\"7200\", \"commandTimeout\":\"600\", \"idleTimeout\":\"270\"}'"
